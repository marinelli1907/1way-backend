                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="character-count">
                                    <input id="short_desc" name="short_desc" class="form-control character-count-field"
                                           ...
                                           placeholder="{{ translate('type_here') }}..." value="{{old('short_desc')}}" required />
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4">
                                    ...
                                    <div class="position-relative">
                                        <input type="number" id="coupon" value="{{old('coupon')}}" name="coupon" class="form-control" placeholder="Ex: 5" step="any" required>
                                        <select class="js-select currency-type-select" id="amount_type" name="amount_type" required>
                        ...
                        <div class="row align-items-start">
                            ...
                            <div class="col-sm-6 col-xl-4">
                                <div class="mb-4 text-capitalize">
                                    ...
                                    <select class="js-select-2" id="customerCouponType" data-placeholder="{{translate('select_customer')}}"
                                            name="customer_coupon_type[]" multiple="multiple" required disabled>
                                    </select>
                                </div>
                            </div>
                            <div class="col-sm-6 col-xl-4 vehicle_category">
                                <div class="mb-4 text-capitalize">
                                    ...
                                    <select id="categoryCouponType" class="js-select-2" data-placeholder="{{translate('select_category')}}"
