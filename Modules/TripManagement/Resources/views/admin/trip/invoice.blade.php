...
<head>
    ...
    <style>
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url({{asset('assets/admin-module/fonts/Inter/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa2JL7SUc.woff2')}}) format('woff2');
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url({{asset('assets/admin-module/fonts/Inter/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa0ZL7SUc.woff2')}}) format('woff2');
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url({{asset('assets/admin-module/fonts/Inter/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa2ZL7SUc.woff2')}}) format('woff2');
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url({{asset('assets/admin-module/fonts/Inter/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa1pL7SUc.woff2')}}) format('woff2');
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url({{asset('assets/admin-module/fonts/Inter/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa2pL7SUc.woff2')}}) format('woff2');
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url({{asset('assets/admin-module/fonts/Inter/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa25L7SUc.woff2')}}) format('woff2');
        ...
        @font-face {
            ...
            font-weight: 100 900;
            font-display: swap;
            src: url({{asset('assets/admin-module/fonts/Inter/UcC73FwrK3iLTeHuS_fvQtMwCp50KnMa1ZL7.woff2')}}) format('woff2');
...
<div class="">
    ...
    <div class="text-center mb-3">
        <img width="160"
             src="{{$businessLogo? asset("storage/app/public/business/".$businessLogo):asset('assets/admin-module/img/invoice-logo.png')}}"
             alt="{{$businessName}}">
    </div>
                ...
                <tr>
                    <td class="text-start">
                        <table style="vertical-align:middle">
                            ...
                            <tr>
                                <td style="width:50px">
                                    <img width="33" src="{{asset('assets/admin-module/img/media/from.png')}}"
                                         alt="">
                                </td>
                                <td>
                        ...
                        <table style="vertical-align:middle; margin-top: 10px">
                            ...
                            <tr>
                                <td style="width:50px">
                                    <img width="33" src="{{asset('assets/admin-module/img/media/to.png')}}"
                                         alt="">
                                </td>
                                <td>
                                    <div class="d-inline-block ml-3 media-body">
