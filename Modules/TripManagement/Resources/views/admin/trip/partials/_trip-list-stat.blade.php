<div class="d-flex flex-wrap gap-2 justify-content-center">
    <div class="card border analytical_data flex-grow-1">
        <div class="card-body">
            <div class="d-flex justify-content-end mb-2">
                <img width="40" src="{{asset('assets/admin-module/img/media/car1.png')}}" class="dark-support" alt="">
            </div>
    ...
    <div class="card border analytical_data flex-grow-1">
        <div class="card-body">
            <div class="d-flex justify-content-end mb-2">
                <img width="40" src="{{asset('assets/admin-module/img/media/car2.png')}}" class="dark-support" alt="">
            </div>
    ...
    <div class="card border analytical_data flex-grow-1">
        <div class="card-body">
            <div class="d-flex justify-content-end mb-2">
                <img width="40" src="{{asset('assets/admin-module/img/media/car3.png')}}" class="dark-support" alt="">
            </div>
    ...
    <div class="card border analytical_data flex-grow-1">
        <div class="card-body">
            <div class="d-flex justify-content-end mb-2">
                <img width="40" src="{{asset('assets/admin-module/img/media/car4.png')}}" class="dark-support" alt="">
            </div>
    ...
    <div class="card border analytical_data flex-grow-1">
        <div class="card-body">
            <div class="d-flex justify-content-end mb-2">
                <img width="40" src="{{asset('assets/admin-module/img/media/car5.png')}}" class="dark-support" alt="">
            </div>
