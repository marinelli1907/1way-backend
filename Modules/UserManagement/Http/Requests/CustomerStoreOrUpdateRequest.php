    ...
    public function rules()
    {
        ...
        return [
            ...
            'confirm_password' => [
                ...
                'same:password'],
            'profile_image' => 'nullable|image|mimes:'  . str_replace(['.', ' '], '', IMAGE_ACCEPTED_EXTENSIONS) . '|max:' . (convertToBytes(maxUploadSize('image')) / 1024),
            ...
            'other_documents.*' => [
                ...
                'max:' . (convertToBytes(maxUploadSize('file')) / 1024)
            ],
            'identity_images.*' => 'image|mimes:'  . str_replace(['.', ' '], '', IMAGE_ACCEPTED_EXTENSIONS) . '|max:' . (convertToBytes(maxUploadSize('image')) / 1024),
