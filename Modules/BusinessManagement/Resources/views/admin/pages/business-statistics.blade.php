                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="upload-file">
                                                    <input type="file" class="upload-file__input"
                                                           accept="image/png, image/jpeg, image/webp" name="total_download_image">
                                                    <span class="edit-btn">
                                    ...
                                    <div class="rounded bg-light px-3 py-2">
                                        <div class="card-body d-flex flex-column gap-3">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="upload-file">
                                                    <input type="file" class="upload-file__input"
                                                           accept="image/png, image/jpeg, image/webp" name="complete_ride_image">
                                                    <span class="edit-btn">
                                                    <i class="bi bi-pencil-square text-primary"></i>
                                                </span>
                                                    <div class="upload-file__img w-auto h-auto" style="--size: 5rem">
                                    ...
                                    <div class="rounded bg-light px-3 py-2">
                                        <div class="card-body d-flex flex-column gap-3">
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <div class="upload-file">
                                                    <input type="file" class="upload-file__input"
                                                           accept="image/png, image/jpeg, image/webp" name="support_image">
                                                    <span class="edit-btn">
                                                    <i class="bi bi-pencil-square text-primary"></i>
                                                </span>
                                                    <div class="upload-file__img w-auto h-auto" style="--size: 5rem">
