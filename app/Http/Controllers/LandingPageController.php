...
class LandingPageController extends Controller
{
    ...
    public function index(): Factory|View|Application
    {
        ...
        // 🟢 FIX APPLIED HERE: Now correctly passes the required string argument 'testimonial'
        $testimonials = $this->businessSetting->getBy(criteria: ['key_name' => TESTIMONIAL, 'settings_type' => LANDING_PAGES_SETTINGS], limit: paginationLimit('testimonial'), offset: 1);
